    ...
    >
      ...
      >
        <div style={{ fontSize: '50px', color: 'white', fontfamily: 'sans-serif', marginBottom: '-20px' }}>
          <b>{programName}</b></div>
        <div style={{ fontSize: '38px', color: '#ffc266', fontfamily: 'Fedra Serif A Pro', marginBottom: '60px' }}>{programdescription}</div>
        <div style={{ fontSize: '38px', color: '#ff9900', marginBottom: '-20px'  }}>{time}</div>
